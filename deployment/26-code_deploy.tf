...
#   deployment_config_name    = "CodeDeployDefault.AllAtOnce"
#   service_role_arn          = aws_iam_role.code_deploy_iam_role.arn
#   autoscaling_groups        = [aws_autoscaling_group.ec2_autoscaling_group.name, aws_autoscaling_group.frontend_autoscaling_group.name]  # Add frontend autoscaling group here
...
#     }
#     target_group_info {
#       name = aws_alb_target_group.server_frontend_tg.name  # Add frontend target group here
#     }
#   }
